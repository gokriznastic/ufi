...
# Model options
parser.add_argument('--dataroot', type=str, default='E:/College/Final Year Project/facenet_pytorch/data/train',
                    help='path to dataset')

parser.add_argument('--lfw-dir', type=str, default='E:/College/Final Year Project/facenet_pytorch/data',
                    help='path to dataset')

parser.add_argument('--ufi-pairs-path', type=str, default='ufi_pairs_1.txt',
                    help='path to pairs file')

parser.add_argument('--log-dir', default='E:/College/Final Year Project/facenet_pytorch/pytorch_face_logs',
...
parser.add_argument('--margin', type=float, default=0.2, metavar='MARGIN',
...
LOG_DIR = args.log_dir + '/run-optim_{}-n{}-lr{}-wd{}-m{}-embeddings{}-msceleb-alpha0'\
...
test_loader = torch.utils.data.DataLoader(
    UFIDataset(dir=args.lfw_dir,pairs_path=args.ufi_pairs_path,
                     transform=transform),
...
def train(train_loader, model, optimizer, epoch):
    ...
    for batch_idx, (data_a, data_p, data_n,label_p,label_n) in pbar:
        ...
        triplet_loss = Variable(triplet_loss, requires_grad=True)
        ...
        loss = triplet_loss + 0.1 * cross_entropy_loss
        ...
        # logger.log_value('cross_entropy_loss', cross_entropy_loss.item()).step()
